...
\author{Yixiao Qian}
\title{Large Language Models are Injective and Invertible}
...
\begin{frame}{Background: LLM Representations}
  \begin{itemize}
    \item Large Language Models (LLMs) use Transformer architectures
    \item Map discrete input sequences to continuous hidden representations
    \item Key question: Are these representations \textbf{lossless}?
  \end{itemize}

  \vspace{1em}
  \textbf{Common assumption:}
  \begin{itemize}
    \item Non-linear activations (GELU, softmax)
    \item Layer normalization
    \item Attention mechanisms
    \item $\Rightarrow$ Different inputs \emph{could} collapse to same representation
  \end{itemize}
\end{frame}
...
\begin{frame}{Research Question}
  \begin{columns}
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../arXiv-2510.15511v3/figures/teaser.pdf}
  ...
  \begin{columns}
    \begin{column}{0.58\textwidth}
      ...
      \begin{itemize}
        ...
        \item Standard initializations avoid measure-zero sets w.p. 1
      \end{itemize}
    \end{column}
    \begin{column}{0.4\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../arXiv-2510.15511v3/figures/real_analytic_fns.png}
...
\begin{frame}{Collision Search Experiments}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{../arXiv-2510.15511v3/figures/combined_swarm_boxplot.pdf}
...
\begin{frame}{Exhaustive Collision Test}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../arXiv-2510.15511v3/figures/exhaustive-gpt2-boxplot.pdf}
...
\begin{frame}{Distance vs Sequence Length}
  \begin{columns}
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../arXiv-2510.15511v3/figures/gpt2-distances-vs-length.pdf}
    ...
    \begin{column}{0.48\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../arXiv-2510.15511v3/figures/gemma-3-1b-pt-distances-vs-length.pdf}
...
\begin{frame}{Invertibility: \textsc{SipIt} Performance}
  \begin{columns}
    ...
    \begin{column}{0.43\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../arXiv-2510.15511v3/figures/sipit_layer_ablation.pdf}
...
\begin{frame}{Limitations \& Future Work}
  \textbf{Known failure cases (by design):}
  \begin{itemize}
    \item Tied embeddings for different tokens
    \item Quantization or non-smooth activations
    \item Deliberately engineered collision parameters
  \end{itemize}

  \vspace{1em}
  \textbf{Future directions:}
  \begin{itemize}
    \item Extend to encoder-decoder architectures
    \item Study injectivity in multi-modal models
    \item Applications in model interpretability
    \item Privacy implications and defenses
    \item Theoretical analysis of other architectures (State Space Models, etc.)
  \end{itemize}
\end{frame}
